...
function loadPlayersPage() {
	for (playerIndex = 0; playerIndex <= players.length; playerIndex++) {
		...
		newlink.setAttribute('onclick', switchPlayers(playerIndex));
		newlink.setAttribute('text', players[playerIndex].name);
	}
	document.getElementById('player_selector').innerHTML = newlink;
}
